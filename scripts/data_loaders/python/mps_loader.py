...
class MPSLoader:
    ...
    def _convert_to_problem_data(self, mps_data: Dict[str, Any],
        ...
        for var_idx, (lo, up) in enumerate(var_bounds):
            if up < np.inf:
        ...
        cone_structure = {
            'free_vars': n_free_vars,
            'nonneg_vars': n_nonneg_vars,
            'soc_cones': [],
            'sdp_cones': []
        }
        ...
        metadata = {
            ...
            'original_dimensions': {
                'variables': n_orig_cols,
                'constraints': n_orig_eq + n_le + n_ge
            },
            'sedumi_dimensions': {
                'variables': n_total_vars,
                'constraints': n_total_constraints
            }
        }
