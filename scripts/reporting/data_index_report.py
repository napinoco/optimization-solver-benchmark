"""
Data export index report generator (extracted from html_generator.py).
"""
...
class DataIndexReportGenerator(ReportGeneratorBase):
    """Generates the data export index page (data/index.html)"""
